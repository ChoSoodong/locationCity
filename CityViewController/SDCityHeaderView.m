...
@interface SDCityHeaderView ()<UISearchBarDelegate>

@property (nonatomic, strong) UILabel *currentCityLabel;
@property (nonatomic, strong) SDButton *button;
@property (nonatomic, strong) UISearchBar *searchBar;

@end

@implementation SDCityHeaderView
...
- (void)addSearchBar {
    ...
    [searchBar mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.offset(KSearchHeight);
...
- (void)addJFButton {
    self.button = [[SDButton alloc] initWithFrame:CGRectMake(self.frame.size.width - 95, self.frame.size.height - 31, 75, 21)];
    ...
    _button.title = @"选择区县";
    _button.titleColor = RGBAColor(155, 155, 155, 1.0);
    [self addSubview:_button];
}

- (void)touchUpJFButtonEnevt:(SDButton *)sender {
